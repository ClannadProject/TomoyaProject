package de.knoobie.project.tomoya.samples.crud;

import de.knoobie.project.tomoya.UIController;
import de.knoobie.project.tomoya.samples.backend.DataService;
...
public class SampleCrudLogic {
    ...
    public void init() {
        ...
        if (!UIController.get().getAccessControl().isUserInRole("admin")) {
    ...
    private void setFragmentParameter(String productId) {
        ...
        Page page = UIController.get().getPage();

...
- TomoyaProject-widgetset: widgetset, custom client side code and dependencies to widget add-ons
- TomoyaProject-ui: main application module, development time
- TomoyaProject-production: module that produces a production mode WAR for deployment

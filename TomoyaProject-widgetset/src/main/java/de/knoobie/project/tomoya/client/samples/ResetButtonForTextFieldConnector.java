package de.knoobie.project.tomoya.client.samples;
...
import de.knoobie.project.tomoya.samples.ResetButtonForTextField;
...
public class ResetButtonForTextFieldConnector extends
    ...
    /*-{
        ...
        el.onclick = $entry(function () {
            self.@de.knoobie.project.tomoya.client.samples.ResetButtonForTextFieldConnector::clearTextField()();
        });
    }-*/;
